  ...
  <div class="container">
    ...
    <div class="countBox">
      <div class="countBox1">
        <div>
          성인
          <button class="descBtn" type="button" @click="showAdultDesc">
            ?
          </button>
        </div>
        <div v-if="adultDesc" class="adultDesc">
      ...
      <div class="countBox2">
        <div>
          유아
          <button class="descBtn" type="button" @click="showChildDesc">
            ?
          </button>
        </div>
        <div v-if="childDesc" class="childDesc">
          국제선 만 12세 미만, 국내선 만 13세 미만
        </div>
        <div class="countBtn">
      ...
      <div class="countBox3">
        <div>
          소아
          <button class="descBtn" type="button" @click="showInfantDesc">
            ?
          </button>
        </div>
