...
<div data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease-out">
    ...
    <div class="rtnInfo">
        <button type="button">
            ...
            <div class="info2">
                <img class="rtnInfoImg" src="../assets/calendar.png" width="25" height="25"> &nbsp;
                <!-- 출발일 -->
            ...
            <!-- 승객 수 -->
            <div class="info3">
                <img class="rtnInfoImg" src="../assets/person.png" width="20" height="20"> &nbsp;
    ...
    <div class="rtnFootNav">
        ...
        <span class="rtnStartPrice">{{AddComma(selectPrice)+ " 원"}}&nbsp;</span>
        <button type="button" v-show="!loginCheck" class="rtnSubmitBtn1" @click="submit()">비회원 결제 하기</button>
        <button type="button" class="rtnSubmitBtn2" @click="loginSubmit()">회원 결제 하기</button>
    </div>
</div>
