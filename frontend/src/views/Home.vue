        ...
        <div class="carousel-inner" id="top">
            ...
            <div class="resForm">
                <div class="res-area-select">
                    ...
                    <!--편도 날짜 선택-->
                    <Datepicker v-if="datePickerShow2" class="datePicker" @update:model-value="datepickerShow2" v-model="oneWay" placeholder=" 가는날" format="yyyy-MM-dd" :min-date="new Date()">
                        <template #month="{ value }">
                            {{ value + 1 + "월"}}
                        </template>
                        <template #month-overlay="{ value }">
