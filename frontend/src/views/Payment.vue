...
export default {
    ...
    data() {
        return {
            ...
            noteInfo: true,
            arrow: "▲",
            korLastName1: this.$store.state.userInfo?.name.substring(0,1),
            korLastName2: "",
            korFirstName1: this.$store.state.userInfo?.name.substring(1,3),
            korFirstName2: "",
