...
[![Watch the video](https://img.youtube.com/vi/RBMja0z1ClM/maxresdefault.jpg)](https://www.youtube.com/watch?v=RBMja0z1ClM)
...
- 프론트에서 받은 인가코드를 통해 각 로그인 API의 토큰 요청과 사용자 정보를 호출하며, 해당 유저가 동의 항목에 체크한 항목의 정보들을 <br>
   데이터베이스에 저장(회원가입)함과 동시에 사용자 정보를 JWT토큰으로 인코딩 후 RedirectView객체를 통해 프론트에 전달합니다.
 <br>
